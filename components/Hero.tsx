...
const Hero: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Precarrega imagens em background
    const imagesToPreload = [
      'https://i.postimg.cc/ZR2L5dX3/10.png',
      'https://i.postimg.cc/y63PrLSm/13.png',
      'https://i.postimg.cc/CLYqH7Ch/rosto-da-Nya.png'
    ];
  ...
  return (
    <section className="relative w-full pt-32 md:pt-48 pb-20 md:pb-32 bg-[#131129] overflow-hidden -mt-px">
      ...
      <div className="px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        {/* Left Column: Text Content - SEMPRE VISÍVEL */}
        <div 
          className={`space-y-8 relative z-20 transition-opacity duration-500 ${
        ...
        {/* Right Column: Visual Elements - CARREGA DEPOIS */}
        <div className="relative flex justify-center items-center h-[550px] md:h-[700px] w-full perspective-1000">
          
          {/* Background Decorations - Só aparecem depois de carregadas */}
          {imagesLoaded && (
            <div className="absolute inset-0 flex justify-center items-center pointer-events-none animate-fadeIn">
              <img 
          ...
          {/* Chat Bubbles - Aparecem progressivamente */}
          <div className={transition-opacity duration-700 ${showContent ? 'opacity-100' : 'opacity-0'}}>
            {/* User Bubble */}
            <div className="absolute top-0 md:top-[10%] right-[5%] md:right-[10%] z-20 max-w-[260px] md:max-w-[280px] animate-float" style={{ animationDelay: '0.3s' }}>
            ...
            {/* Nya Bubble */}
            <div className="absolute top-[25%] md:top-[35%] left-[5%] md:left-[10%] z-30 max-w-[340px] md:max-w-[400px] animate-float" style={{ animationDelay: '0.6s' }}>
              <div className="flex gap-4 items-start">
                {/* Nya Avatar - Carrega lazy */}
                <div className="w-14 h-14 md:w-16 md:h-16 rounded-full border-2 border-[#aae4a7]/30 shadow-[0_0_30px_rgba(170,228,167,0.2)] overflow-hidden flex-shrink-0 bg-midnight relative group">
                  ...
                  {imagesLoaded && (
                    <img 
                      src="https://i.postimg.cc/CLYqH7Ch/rosto-da-Nya.png" 
                      alt="Nya" 
                      className="w-full h-full object-cover relative z-10 animate-fadeIn"
                      loading="lazy"
                    />
                  )}
                </div>
            ...
            {/* Input Bar */}
            <div className="absolute bottom-16 md:bottom-[15%] left-0 right-0 mx-auto w-[90%] md:w-[450px] z-30 animate-float" style={{ animationDelay: '0.9s' }}>
